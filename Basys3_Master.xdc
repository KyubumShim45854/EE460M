...
set_property PACKAGE_PIN E19 [get_ports {second}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {second}]
set_property PACKAGE_PIN U19 [get_ports {curFSM[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {curFSM[0]}]
set_property PACKAGE_PIN V19 [get_ports {curFSM[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {curFSM[1]}]
set_property PACKAGE_PIN W18 [get_ports {lightPulse}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {lightPulse}]
